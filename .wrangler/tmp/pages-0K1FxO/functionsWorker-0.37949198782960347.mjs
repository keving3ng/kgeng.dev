  ...
  try {
    ...
    const jsonResponse = new Response(JSON.stringify(posts), {
      headers: {
        "Content-Type": "application/json",
        "Access-Control-Allow-Origin": "*",
        "Cache-Control": `public, max-age=${CACHE_TTL2}`
      }
    });
    context.waitUntil(cache.put(cacheKey, jsonResponse.clone()));
    return jsonResponse;
...
// ../.wrangler/tmp/pages-0K1FxO/functionsRoutes-0.9025829177098699.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-VK0ykg/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-VK0ykg/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.37949198782960347.mjs.map
